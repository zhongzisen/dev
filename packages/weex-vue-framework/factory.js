  ...
  function patchVnode (
    ...
    if (isUndef(vnode.text)) {
      if (isDef(oldCh) && isDef(ch)) {
        ...
        // 如果新节点和旧节点均没有children，但是旧节点有text，直接将旧节点的text清空，这是因为此时新节点的text为undefined，这是在isUndefined(vnode.text)判断中
        nodeOps.setTextContent(elm, '');
      }
    } else if (oldVnode.text !== vnode.text) {
      // 新节点有text且新节点和旧节点的text不同，直接将新节点的text赋值给旧节点
